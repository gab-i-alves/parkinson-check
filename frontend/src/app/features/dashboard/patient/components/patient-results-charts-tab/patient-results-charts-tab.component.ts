...
@Component({
  selector: 'app-patient-results-charts-tab',
  standalone: true,
  imports: [CommonModule, FormsModule],
  templateUrl: './patient-results-charts-tab.component.html',
})
export class PatientResultsChartsTabComponent implements OnChanges {
